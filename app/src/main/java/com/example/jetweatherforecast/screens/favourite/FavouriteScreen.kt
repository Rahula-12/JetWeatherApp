        ...
        topBar = {
            ...
            Surface(
                ...
                val list=favouriteViewModel.favouriteList.collectAsState().value
                    LazyColumn{
                        items(items=list){fav->
                            CityRow(favourite=fav,favouriteViewModel=favouriteViewModel,navController=navController)
                        }
                    }
                }
            }
...
fun CityRow(
    ...
    Surface(
        ...
        Row(
            ...
            Text(favourite.city,modifier = Modifier.padding(start = 4.dp), color = MaterialTheme.colorScheme.onSurface)
            Surface(
                shape = CircleShape,
